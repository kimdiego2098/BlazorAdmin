...
public partial class UserChoice
{
    ...
    public List<long> ChoiceValues { get; set; }
    ...
    [Parameter]
    [NotNull]
    public EventCallback<List<long>> ValuesChanged { get; set; }
    ...
    private async Task OnValueChanged(List<long> values, bool change = false)
    {
