...
public interface ISysUserService
{
    ...
    Task<List<long>?> GetCurrentUserDataScopeAsync();
    ...
    Task<SysUser?> GetUserByAccountAsync(string account, long? tenantId);
    ...
    /// <param name="input">查询选项。</param>
    /// <returns>用户信息列表。</returns>
    Task<QueryData<SysUser>> PageAsync(QueryPageOptions option, UserSelectorInput input);
