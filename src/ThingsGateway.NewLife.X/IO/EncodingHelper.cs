...
namespace ThingsGateway.NewLife.IO
{
    ...
    public static class EncodingHelper
    {
        ...
        private static Encoding DetectInternal(Byte[] data)
        {
        ...
        private static Boolean IsMatch(Byte[] data, Encoding encoding)
        {
        ...
        /// <param name="bt"></param>
        /// <returns></returns>
        private static Boolean IsCommonASCII(Byte bt)
        {
            if (bt is 0x0A // 回车
                or 0x0D // 换行
                or 0x09 // 制表符
